...
namespace PainelWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var configuracao = new ConexaoBanco();

            new ConfigureFromConfigurationOptions<ConexaoBanco>(Configuration.GetSection("ConexaoBanco")).Configure(configuracao);

            InjecaoDeDependecia(services);
